...
{
  "$end", "error", "$undefined", "INTEGER", "FLOAT", "END",
  "END_STATEMENT", "POINT", "LINE", "CIRCLE", "RECTANGLE", "SET_COLOR",
  "$accept", "zoom", "statement_list", "statement", "point", "line",
...
#line 45 "zoomjoystrong.y" /* yacc.c:1646  */
    { 
					if((yyvsp[-2].i) < 0 || (yyvsp[-2].i) > 1024 || (yyvsp[-1].i) < 0 || (yyvsp[-1].i) > 768)
...
#line 53 "zoomjoystrong.y" /* yacc.c:1646  */
    { 
					if((yyvsp[-4].i) < 0 || (yyvsp[-4].i) > 1024 || (yyvsp[-3].i) < 0 || (yyvsp[-3].i) > 768 
					|| (yyvsp[-2].i) < 0 || (yyvsp[-2].i) > 1024 || (yyvsp[-1].i) < 0 || (yyvsp[-1].i) > 768)
...
#line 62 "zoomjoystrong.y" /* yacc.c:1646  */
    { 
					if((yyvsp[-3].i) < 0 || (yyvsp[-3].i) > 1024 || (yyvsp[-2].i) < 0 || (yyvsp[-2].i) > 768 
					|| (yyvsp[-1].i) < 0 || (yyvsp[-1].i) > 1024)
